# Generated by Django 4.1.7 on 2023-05-01 04:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('views', models.CharField(blank=True, max_length=200)),
                ('date_posted', models.DateTimeField(auto_now=True)),
                ('item_name', models.CharField(max_length=200)),
                ('description', models.TextField(blank=True, null=True)),
                ('sale_price', models.CharField(blank=True, max_length=200)),
                ('original_price', models.CharField(blank=True, max_length=200)),
